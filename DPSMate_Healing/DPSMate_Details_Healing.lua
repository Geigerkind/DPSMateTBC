...
function DPSMate.Modules.DetailsHealing:ScrollFrame_Update(comp)
	...
	for line=1,10 do
		...
		if uArr[lineplusoffset] ~= nil then
			...
			_G("DPSMate_Details_"..comp.."Healing_Log_ScrollButton"..line.."_Icon"):SetTexture(DPSMate:GetSpellIcon(strsub(ability, 1, (strfind(ability, "%(") or 0)-1) or ability))
			if len < 10 then
...
function DPSMate.Modules.DetailsHealing:SelectDetails_HealingButton(i, comp, cname)
	...
	_G("DPSMate_Details_"..comp.."Healing_LogDetails_Healing_Average0"):SetText(ceil(hitav/DPSMate:ProbZero(hit)))
	...
	_G("DPSMate_Details_"..comp.."Healing_LogDetails_Healing_Average1"):SetText(ceil(critav/DPSMate:ProbZero(crit)))
