...
function DPSMate.Modules.DetailsDamageTaken:SelectDetailsButton(p,i,comp,cname)
	...
	_G("DPSMate_Details_"..comp.."DamageTaken_LogDetails_Average1"):SetText(ceil(blockav/DPSMate:ProbZero(block)))
	...
	_G("DPSMate_Details_"..comp.."DamageTaken_LogDetails_Average2"):SetText(ceil(crushav/DPSMate:ProbZero(crush)))
	...
	_G("DPSMate_Details_"..comp.."DamageTaken_LogDetails_Average3"):SetText(ceil(hitav/DPSMate:ProbZero(hit)))
	...
	_G("DPSMate_Details_"..comp.."DamageTaken_LogDetails_Average4"):SetText(ceil(critav/DPSMate:ProbZero(crit)))
...
function DPSMate.Modules.DetailsDamageTaken:SortLineTable(arr, b, cname)
	local newArr = {}
	if b then
		for cat, val in pairs(arr[DPSMateUser[cname or DetailsUser][1]][b]) do
			if val["i"] then
