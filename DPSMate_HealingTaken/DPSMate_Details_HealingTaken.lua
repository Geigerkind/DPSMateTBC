...
function DPSMate.Modules.DetailsHealingTaken:SelectDetailsButton(p,i, comp, cname)
	...
	_G("DPSMate_Details_"..comp.."HealingTaken_LogDetails_Average1"):SetText(ceil(hitav/DPSMate:ProbZero(hit)))
	...
	_G("DPSMate_Details_"..comp.."HealingTaken_LogDetails_Average2"):SetText(ceil(critav/DPSMate:ProbZero(crit)))
