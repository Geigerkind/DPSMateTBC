...
function DPSMate.Modules.Decurses:IsValid(ab, cast, user)
	if DPSMateAbility[ab][2]==DPSMate.L["curse"] or (DPSMateAbility[ab][2]=="" and ((DPSMate.Parser.DeCurse[cast] and DPSMateAbility[ab][2]=="") or (DPSMate.Parser.DeCurse[cast] and DPSMateAbility[ab][2]==DPSMate.L["curse"]))) then
		return true
	end
	return false
end
