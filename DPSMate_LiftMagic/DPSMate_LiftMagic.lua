...
function DPSMate.Modules.LiftMagic:IsValid(ab, cast)
	if DPSMateAbility[ab][2]==DPSMate.L["magic"] or (DPSMate.Parser.DeMagic[cast] and DPSMateAbility[ab][2]=="") or (DPSMate.Parser.DeMagic[cast] and DPSMateAbility[ab][2]==DPSMate.L["magic"]) then
		return true
	end
	return false
end
